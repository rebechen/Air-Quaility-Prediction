...
#sh_data = read.csv(file="./Desktop/STAT844/project/FiveCitiePMData/ShanghaiPM20100101_20151231.csv",header = TRUE,sep="," ,row.names=NULL )
#bj_data = read.csv(file="./Desktop/STAT844/project/FiveCitiePMData/BeijingPM20100101_20151231.csv",header = TRUE,sep=",",row.names=NULL  )
#cd_data = read.csv(file="./Desktop/STAT844/project/FiveCitiePMData/ChengduPM20100101_20151231.csv",header = TRUE,sep="," ,row.names=NULL )
...
#sy_data = read.csv(file="./Desktop/STAT844/project/FiveCitiePMData/ShenyangPM20100101_20151231.csv",header = TRUE,sep=",",row.names=NULL  )
